...
export default function CardInputDivisi() {
    ...
    async function handleSubmit(values) {
        await divisiApi.addDivisi(values).then(res => {
            if (res) {
                navigate("/divisi", {
                    state: {
                                                    ...
                                                    {({ field, form }) => (
                                                        <>
                                                            <SuiBox>
                                                                ...
                                                                <input type="text" className={form.errors.nama_divisi && form.touched.nama_divisi ? "form-control is-invalid" : "form-control"} name="nama_divisi" {...field} />
